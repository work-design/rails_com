...
module RailsCom::AssetsHelper
  ...
  def js_load(filename = nil, root: nil, **options)
    ...
    rails_path = Rails.root + relative_path
    engine_path = @_rendered_from + relative_path
    result = [
      rails_path.to_s + '.js',
  ...
  def css_load(filename = nil, root: nil, **options)
    ...
    rails_path = Rails.root + relative_path + '.css'
    engine_path = @_rendered_from + relative_path + '.css'
