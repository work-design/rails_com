...
module RailsCom::Application
  ...
  def set_variant
    ...
    logger.debug "  \e[35mVariant: #{request.variant}\e[0m"
  end
  ...
  def set_timezone
    ...
    logger.debug "  \e[35mZone: #{Time.zone}\e[0m"
  end
  ...
  def set_locale
    ...
    logger.debug "  \e[35mLocale: #{I18n.locale}\e[0m"
  end
  ...
  def set_country
    ...
    logger.debug "  \e[35mCountry: #{session[:country]}\e[0m"
  end
