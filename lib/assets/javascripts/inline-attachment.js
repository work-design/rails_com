...
(function(document, window) {
  ...
  var InputAttachment = function(options) {
    ...
    this.editor = InputAttachment.editors.initEditor(this.settings['input']);
    this.fileInput = InputAttachment.editors.initFileInput(this.settings['fileInput']);
